...
const SHELL = [
  ...
  './js/price.js', './js/parse.js', './js/import-view.js', './js/sale.js', './js/sale-view.js', './js/chart.js', './js/sales.js', './js/spec.js', './js/theme.js', './js/skin.js', './js/analysis.js', './js/analytics-view.js', './js/lifeplan.js', './js/lifeplan-view.js',
