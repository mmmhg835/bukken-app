...
| | |
|---|---|
| 現在の版 | アプリ v34 / データスキーマ v14 |
| 規模 | JS 約5,300行・22モジュール |
| 画面 | 一覧 / 比較 / 分析 / ライフプラン / 地図 / 設定（ライフプランは ライフプラン・返済負担比率・グラフ の3サブタブ） |
...
- 掲載ページの URL や貼り付けたテキストから項目を起こす取り込み
- 過去の募集情報の一括登録（形式はユーザーに確認する）
- 写真の一括アップロード（フォルダごと投入して物件へ振り分け）
