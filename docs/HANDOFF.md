...
建物13棟・部屋18室。**SUUMO の物件概要をスクショで読み取って投入した。**

| エリア | 建物 |
|---|---|
| 江東区 東雲 | W Comfort Towers WEST / Wコンフォートタワーズ イースト / アップルタワー東京キャナルコート / パークタワー東雲 |
| 江東区 有明 | ブリリアマーレ有明 TOWER&GARDEN / シティタワー有明 / ブリリア有明シティタワー |
| 川崎市 幸区 | グラン・エステ川崎ツインタワー弐番館 / サンクタス川崎タワー |
| 川崎市 中原区 | プランヴェール等々力緑地 / 武蔵小杉ヒルズソルシード / プラウドタワー武蔵小杉 |
| 横浜市 西区 | ヨコハマタワーリングスクエア EAST |

価格帯は 9,280万〜1億7,980万、坪単価は 283万〜611万。全建物に住所・座標が入って
いるので、地図とエリア別相場が動く。設備タグ・共用施設タグ・建物構造タグ
（免震／制震／耐震）も入っている。

**まだ全室で未入力なもの**: 登録日（`listedAt`）・価格推移（`priceHistory`）。
このため販売期間・値下げ分析はまだ動かない。写真は p1（39階）の16枚と
b1 の1枚だけ。

**住所は多くが番地まで入っていない**（SUUMO が丁目までしか出さないため）。
番地まで取れているのは W Comfort Towers WEST（東雲1-9-31）・アップルタワー
（東雲1-9-41）・ブリリアマーレ有明（有明1-4-11）・サンクタス川崎タワー
（中幸町3-16-4）の4棟。**残り9棟は最後にまとめて整える**とユーザーと合意済み。

**掲載間の食い違いはメモに両論併記してある**（総戸数・管理形態・駅までの分数・
駐車場の有無など）。同じ建物を別の仲介が別々に掲載していると普通に起きる。
勝手にどちらかへ寄せず、採用した側と理由をメモに残すこと。
